                            ...
                            <v-flex md8 xs12 offset-md1>
                                <div class="py-2">
                                    <v-select title="Target Muscle" id="id_target_muscle" name="target_muscle"
                                              v-model="target_muscle" v-bind:items="target_muscles" label="Primary Muscle" :rules="[rules.required]"
                                              ></v-select>
                                </div>
                            </v-flex>
                            <v-flex md8 xs12 offset-md1>
                                <div class="py-2">
                                    <v-select
                                            ...
                                            :items="taggedMuscles"
                                            item-text="name"
                                            label="Secondary Muscles"></v-select>
                                </div>
                            </v-flex>
                            <v-flex md8 xs12 offset-md1>
                                <div class="py-2">
    ...
    data () {
      ...
      methods: {
          ...
          querySelections: _.debounce(function (v) {
                  ...
                  axios.get(baseURLLocal + 'v1/exercises/').then(response => {
        ...
        addExercise: function () {
          ...
          fetchTaggedMuscles() {
            axios.get(baseURLLocal+'v1/target-muscles/').then(response => {
                this.muscles = response.data.results;
            }).catch(err => {
                console.log(err)
            })
          },
