<template>
    <v-app id="dashboard">
        ...
        <v-footer class="pa-3" app fixed>
            <p ><small>Last Build: </small>{{ "05/30/2018" | moment }}</p>
    <v-spacer></v-spacer>
    <div>© {{ new Date().getFullYear() }}</div>
            <p style="position: absolute; left: 50%">v0.6.7.7 </p>
...
import AccountSettings from '../account-profile-settings/account-settings.vue'
