                      ...
                      >
                        <v-card>
                            <v-layout  row wrap>
                                ...
                                <v-layout container row wrap justify-center align-center class="py-0" v-if="props.item.muscles.length > 0">
                                    <v-flex xs12 py-0>
                                        <h6 class="caption grey--text text--darken-2 text-xs-left">Also Trained</h6>
                                    </v-flex>
                                    <v-flex xs8 offset-xs4 class="text-md-right">
                                        <template v-for="muscle in props.item.muscles">
                                            <v-chip color="secondary" text-color="white" small>{{ muscle.name }}</v-chip>
                                        </template>
                                    </v-flex>
                                </v-layout>
                                <v-flex xs10 class="pb-2" v-if="isEmailWorkout">

                                    <v-card raised  style="border-color: lightslategray; border-bottom-width: 5px;
